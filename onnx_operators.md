...
| AveragePool | 平均値プーリング | [export](python/04_AveragePool_export.py) / [inference](python/04_AveragePool_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/04_avgpool.onnx) |
| GlobalAveragePool | グローバル平均プーリング | [export](python/05_GlobalAveragePool_export.py) / [inference](python/05_GlobalAveragePool_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/05_globalavgpool.onnx) |
| LayerNormalization | レイヤー正規化 | [export](python/06_LayerNormalization_export.py) / [inference](python/06_LayerNormalization_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/06_layernorm.onnx) |
...
| LeakyRelu | Leaky ReLU活性化関数 | [export](python/10_LeakyRelu_export.py) / [inference](python/10_LeakyRelu_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/10_leakyrelu.onnx) |
...
| HardSigmoid | Hard Sigmoid（区分線形近似） | [export](python/16_HardSigmoid_export.py) / [inference](python/16_HardSigmoid_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/16_tanh.onnx) |
| HardSwish | Hard Swish活性化関数 | [export](python/17_HardSwish_export.py) / [inference](python/17_HardSwish_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/17_clip.onnx) |
| Tanh | ハイパボリックタンジェント | [export](python/18_Tanh_export.py) / [inference](python/18_Tanh_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/18_reshape.onnx) |
...
| Div | 2つのテンソルの要素ごとの除算 | [export](python/20_Div_export.py) / [inference](python/20_Div_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/22_div.onnx) |
...
| Neg | テンソルの符号を反転 | [export](python/22_Neg_export.py) / [inference](python/22_Neg_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/24_neg.onnx) |
...
| Sub | 2つのテンソルの要素ごとの減算 | [export](python/24_Sub_export.py) / [inference](python/24_Sub_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/20_sub.onnx) |
...
| Clip | テンソルの値を指定範囲にクリップ | [export](python/28_Clip_export.py) / [inference](python/28_Clip_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/28_transpose.onnx) |

## 4. テンソル操作 (Tensor Operations)

| オペレータ | 説明 | Pythonコード | ONNXモデル |
|-----------|------|-------------|-----------|
| Reshape | テンソルの形状を変更 | [export](python/29_Reshape_export.py) / [inference](python/29_Reshape_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/29_flatten.onnx) |
...
| GreaterOrEqual | 要素ごとの以上比較 (A >= B) | [export](python/44_GreaterOrEqual_export.py) / [inference](python/44_GreaterOrEqual_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/44_less.onnx) |
| Less | 要素ごとの小なり比較 (A < B) | [export](python/45_Less_export.py) / [inference](python/45_Less_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/45_and.onnx) |
| LessOrEqual | 要素ごとの以下比較 (A <= B) | [export](python/46_LessOrEqual_export.py) / [inference](python/46_LessOrEqual_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/46_or.onnx) |

## 7. 集約・統計演算 (Reduction Operations)

| オペレータ | 説明 | Pythonコード | ONNXモデル |
|-----------|------|-------------|-----------|
| ReduceSum | 指定軸に沿った合計 | [export](python/47_ReduceSum_export.py) / [inference](python/47_ReduceSum_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/47_reducesum.onnx) |
| ReduceMean | 指定軸に沿った平均 | [export](python/48_ReduceMean_export.py) / [inference](python/48_ReduceMean_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/48_reducemean.onnx) |
| ReduceMax | 指定軸に沿った最大値 | [export](python/49_ReduceMax_export.py) / [inference](python/49_ReduceMax_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/49_reducemax.onnx) |
| ReduceMin | 指定軸に沿った最小値 | [export](python/50_ReduceMin_export.py) / [inference](python/50_ReduceMin_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/50_reducemin.onnx) |
| ReduceProd | 指定軸に沿った積 | [export](python/51_ReduceProd_export.py) / [inference](python/51_ReduceProd_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/51_reduceprod.onnx) |
| ReduceL2 | L2ノルム (√Σx²) | [export](python/52_ReduceL2_export.py) / [inference](python/52_ReduceL2_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/53_reducel2.onnx) |
| ReduceL1 | L1ノルム (Σ\|x\|) | [export](python/53_ReduceL1_export.py) / [inference](python/53_ReduceL1_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/52_reducel1.onnx) |
| ReduceSumSquare | 二乗和 (Σx²) | [export](python/54_ReduceSumSquare_export.py) / [inference](python/54_ReduceSumSquare_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/56_reducesumsquare.onnx) |
| ReduceLogSumExp | log(Σe^x)（数値安定版） | [export](python/55_ReduceLogSumExp_export.py) / [inference](python/55_ReduceLogSumExp_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/55_reducelogsumexp.onnx) |
| ReduceLogSum | log(Σx) | [export](python/56_ReduceLogSum_export.py) / [inference](python/56_ReduceLogSum_inference.py) | [Netron](https://netron.app/?url=https://raw.githubusercontent.com/nnn112358/ONNX-Operater-onnxscript/main/onnx/54_reducelogsum.onnx) |
